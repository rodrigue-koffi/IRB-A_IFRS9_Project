...
Pipeline Python modulaire de notation interne (IRB-A) et de provisionnement IFRS 9, construit à partir du jeu de données German Credit Data, retraité pour simuler un cycle de vie de crédit réaliste ( périmètre Retail/PME, coûts de recouvrement, tests de stress).
...
Les dates, le périmètre PME/Corporate, les revenus et les flux de recouvrement sont **simulés** :