...
- **Aucune simplification volontaire** : formule de Bâle complète (corrélation, ajustement de maturité), LGD par méthode workout, PD calibrée en Long Run Average + MoC A/B/C sur un panel d'observations multi-années, stress test inverse résolu numériquement.
